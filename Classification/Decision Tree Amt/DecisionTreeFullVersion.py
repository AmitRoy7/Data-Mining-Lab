    ...
    def attribute_selection_method(self, attribute_names, attribute_types, attribute_list
        ...
        if attribute_types[bestAttributeIdx] == 0:
            ...
            try:
                ...
                print("Exceptionnnnnnnn",ai0,ai1,ai0+ai1)
                exit(0)
...
if __name__ == '__main__':
    ...
    while True:
        ...
        for train_index, test_index in kf.split(X):
            ...
            print("\t\tFold\t#%d\tAccuracy(%%):\t%0.2lf\tTraining:\t%d\tTest3:\t%d\t"%(curFold,foldAccuraccy,len(X_train),len(X_test)))
        ...
        print("\n\t\tNumber of Folds: ",numFold,"Avg Accuracy: %0.2lf"%accuracy)
